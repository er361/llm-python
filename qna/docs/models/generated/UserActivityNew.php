...
/**
 * This is the model class for table "user_activity_new".
 *
 * @property int $id
 ...
 * @property User $user
 */
class UserActivityNew extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['user_id', 'tz_offset', 'start_offset', 'duration', 'activity', 'block_id'], 'integer'],
            [['utc_time_15m'], 'safe'],
